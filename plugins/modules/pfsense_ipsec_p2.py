...
from ansible_collections.opoplawski.pfsense.plugins.module_utils.network.pfsense.pfsense_ipsec_p2 import PFSenseIpsecP2Module, IPSEC_P2_ARGUMENT_SPEC, IPSEC_P2_REQUIRED_IF
...
def main():
    ...
    pfipsec = PFSenseIpsecP2Module(module)
