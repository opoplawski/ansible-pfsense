...
from ansible.module_utils.network.pfsense.interface import PFSenseInterfaceModule, INTERFACE_ARGUMENT_SPEC, INTERFACE_REQUIRED_IF, INTERFACE_MUTUALLY_EXCLUSIVE
